...
def parse_text_to_datum(self, line_columns: List[str]) -> PopulationChangeDatum:
    ...
    if cbsa_status_indicator_string and cbsa_status_indicator_string != CONSTANTS.IGNORED_COLUMN_VALUE and not is_int(
            cbsa_status_indicator_string):
    ...
    if total_population_in_2000_string and total_population_in_2000_string != CONSTANTS.IGNORED_COLUMN_VALUE and not is_int(
            total_population_in_2000_string):
    ...
    if total_housing_units_in_2000_string and total_housing_units_in_2000_string != CONSTANTS.IGNORED_COLUMN_VALUE and not is_int(
            total_housing_units_in_2000_string):
        raise ArithmeticError(
            f"Total Housing Units in 2000 is set to {total_population_in_2000_string} which is invalid!")
    ...
    if total_population_in_2010_string and total_population_in_2010_string != CONSTANTS.IGNORED_COLUMN_VALUE and not is_int(
            total_population_in_2010_string):
    ...
    if total_housing_units_in_2010_string and total_housing_units_in_2010_string != CONSTANTS.IGNORED_COLUMN_VALUE and not is_int(
            total_housing_units_in_2010_string):
        raise ArithmeticError(
            f"Total Housing Units in 2010 is set to {total_housing_units_in_2010_string} which is invalid!")
    ...
    if numeric_population_change_string and numeric_population_change_string != CONSTANTS.IGNORED_COLUMN_VALUE and not is_int(
            numeric_population_change_string):
        raise ArithmeticError(
            f"Numeric Population Change is set to {numeric_population_change_string} which is invalid!")
    ...
    if percent_population_change_string and percent_population_change_string != CONSTANTS.IGNORED_COLUMN_VALUE and not is_float(
            percent_population_change_string):
        raise ArithmeticError(
            f"Percent Population Change is set to {percent_population_change_string} which is invalid!")
    ...
    if numeric_housing_units_change_string and numeric_housing_units_change_string != CONSTANTS.IGNORED_COLUMN_VALUE and not is_int(
            numeric_housing_units_change_string):
        raise ArithmeticError(
            f"Numeric Housing Units Change is set to {numeric_housing_units_change_string} which is invalid!")
    ...
    if percent_housing_units_change_string and percent_housing_units_change_string != CONSTANTS.IGNORED_COLUMN_VALUE and not is_float(
            percent_housing_units_change_string):
        raise ArithmeticError(
            f"Percent Housing Units Change is set to {percent_housing_units_change_string} which is invalid!")
